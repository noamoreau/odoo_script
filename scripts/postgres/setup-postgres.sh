...
ssh postgres1 "sudo -S '0 0 * * * pg_dumpall > /var/lib/postgresql/testfile'>>POSITION CRONTAB"
ssh postgres1 "sudo -S '1 0 * * * rsync postgres@10.42.124.2:/var/lib/postgresql/test.sql /home/user/test'>>POSTION CRONTAB "
